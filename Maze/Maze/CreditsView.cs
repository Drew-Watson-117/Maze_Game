...
namespace Maze
{
    internal class CreditsView : GameView
    {
        public CreditsView(GraphicsDeviceManager graphics, ContentManager content, State currentState) : base(graphics, content, currentState)
        {
        }
